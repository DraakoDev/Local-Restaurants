...
const restaurants = [
  {
    ...
    page: "https://labarrarestaurante.com/",
    description:
  ...
  },
  {
    ...
    category: "Restaurante, Bar de vinos",
    page: "https://in-situ.com/",
    description:
  ...
  },
  {
    ...
    page: "https://www.andrescarnederes.com/",
    description:
  ...
  },
  {
    ...
    category: "Restaurante",
    page: "https://pacoelchato.org/",
    description:
      "Este restaurante familiar, con un ambiente tradicional y acogedor, ofrece platos colombianos caseros a precios muy razonables. Su especialidad es la bandeja paisa, un plato típico colombiano que incluye carne de res, chorizo, morcilla, chicharrón, arepas, aguacate y frijoles.",
  },
];

export { navLinks, restaurants };
